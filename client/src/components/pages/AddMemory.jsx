...
class AddMemory extends Component {
    ...
    render() {
        return (
          <div className="forms">
            <h2 class="pb-4">New Memory</h2>
            <Form onSubmit={e => this.handleSubmit(e)}>
                <FormGroup row>
                <Label for="title" sm={2} class="pr-4">Title</Label>
                <Col sm={10}>
                <Input
                    class="p-2" 
                    type="text" 
                ...
                <FormGroup row>
                <Label for="notes" sm={2} class="pr-4">Notes</Label>
                <Col sm={10}>
                <Input
                    class="p-2" 
                    type="textarea" 
                ...
                <Button outline color="info" type="submit">Save new memory</Button>
            </Form>
          </div>
        );
    }
